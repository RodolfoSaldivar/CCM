...
<?php $this->set("breadcrumbs",
	...
	<a class="breadcrumb">Importar colegios</a>'
) ?>
...
<?php echo $this->Form->create(array('type' => 'file')); ?>
	...
	<div class="bg_blanco">
		<div class="contenedor">
			...
			<div class="row">
				<h5>
					Instrucciones para importar varios colegios con plantilla de Excel:
				</h5>
			</div>
					...
					<ol>
						<li>Descargar el archivo Excel.</li>
							<div style="padding: 0px 0px 30px 0px;" class="input-field">
								<a href="/colegios/descargar_excel/plantillaColegios" class="waves-effect waves-light btn">Descargar</a>
							</br>
							</div>
...
$("#menu_cole").addClass("activado");
	...
	$('#ColegioSubirExcelForm').validate({
		rules: {
			'data[archivo]': {
				required: true
			}
	...
	$('#ColegioSubirExcelForm').submit(function(event)
	{
		if ($('#ColegioSubirExcelForm').valid())
		{
