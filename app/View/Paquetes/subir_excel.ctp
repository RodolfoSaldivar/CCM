...
<?php $this->set("breadcrumbs",
	...
	<a class="breadcrumb">Importar paquetes</a>'
) ?>
...
<?php echo $this->Form->create(array('type' => 'file')); ?>
	...
	<div class="bg_blanco">
		<div class="contenedor">
			...
			<div class="row">
				<h5>
					Instrucciones para importar varios paquetes con plantilla de Excel:
				</h5>
			</div>
					...
					<ol>
						<li>Descargar el archivo Excel.</li>
							<div style="padding: 0px 0px 30px 0px;" class="input-field">
								<a href="/paquetes/descargar_excel/plantillaPaquetes" class="waves-effect waves-light btn">Descargar</a>
							</br>
							</div>
...
$("#menu_paqu").addClass("activado");
	...
	$('#PaqueteSubirExcelForm').validate({
		rules: {
			'data[archivo]': {
				required: true
			}
	...
	$('#PaqueteSubirExcelForm').submit(function(event)
	{
		if ($('#PaqueteSubirExcelForm').valid())
		{
