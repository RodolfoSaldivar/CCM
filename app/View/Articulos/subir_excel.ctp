...
<?php $this->set("breadcrumbs",
	...
	<a class="breadcrumb">Importar artículos</a>'
) ?>
...
<?php echo $this->Form->create(array('type' => 'file')); ?>
	...
	<div class="bg_blanco">
		<div class="contenedor">
			...
			<div class="row">
				<h5>
					Instrucciones para importar varios artículos con plantilla de Excel:
				</h5>
			</div>
					...
					<ol>
						<li>Descargar el archivo Excel.</li>
							<div style="padding: 0px 0px 30px 0px;" class="input-field">
								<a href="/articulos/descargar_excel/plantillaCatalogoArticulos" class="waves-effect waves-light btn">Descargar</a>
							</br>
							</div>
...
$("#menu_arti").addClass("activado");
	...
	$('#ArticuloSubirExcelForm').validate({
		rules: {
			'data[archivo]': {
				required: true
			}
	...
	$('#ArticuloSubirExcelForm').submit(function(event)
	{
		if ($('#ArticuloSubirExcelForm').valid())
		{
